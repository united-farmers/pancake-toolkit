...
export interface UfxToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  ...
  ufxThickness: "ufxThickness",
  ufxTwoOffset: "ufxTwoOffset",
  ufxThreeOffset: "ufxThreeOffset",
  butterTop: "butterTop",
