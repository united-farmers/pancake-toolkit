...
it("renders correctly with unit prop and switchEditingUnits", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c9:hover:not(:disabled):not(.ufx-button--disabled):not(.ufx-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c9:active:not(:disabled):not(.ufx-button--disabled):not(.ufx-button--disabled) {
      opacity: 0.85;
