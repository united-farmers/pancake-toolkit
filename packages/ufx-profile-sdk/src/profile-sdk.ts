...
class UfxProfileSdk {
   ...
   * API repo - https://github.com/united-farmers-finance/ufx-profile-api
   */
   ...
   * Contract repo - https://github.com/unitedfarmers/pancake-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from UfxProfile contract.
   * NFT's bunnyId is retrieved from UfxBunnies contract and mapped to static NFT data stored in constant.
  ...
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://unitedfarmers.finance/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "unitedfarmers.finance", secure: true, expires: 30 }
        );
      }
